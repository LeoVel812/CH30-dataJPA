...
public interface CustomerRepository extends CrudRepository<Customer, Long> {
	...
	// this is another method, overridden method, in order to use another argument (long id)
	// and return that type of object
	 Customer findById(long id); // if the element not exist, throws an error
